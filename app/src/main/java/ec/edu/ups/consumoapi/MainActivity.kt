                ...
                if (response.getString("Response") == "True") {
                    ...
                    if (movie != null) {
                        ...
                        btmMore.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID", movie.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    } else {
                    ...
                    if (movie2 != null) {
                        ...
                        btmMore2.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID",movie2.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
                    ...
                    if (movie3 != null) {
                        ...
                        btmMore3.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID", movie3.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
                    ...
                    if (movie4 != null) {
                        ...
                        btmMore4.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID", movie4.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
                    ...
                    if (movie5 != null) {
                        ...
                        btmMore5.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID",movie5.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
                    ...
                    if (movie6 != null) {
                        ...
                        btmMore6.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID", movie6.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
                    ...
                    if (movie7 != null) {
                        ...
                        btmMore7.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID", movie7.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
                    ...
                    if (movie8 != null) {
                        ...
                        btmMore8.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID", movie8.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
                    ...
                    if (movie9 != null) {
                        ...
                        btmMore9.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID", movie9.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
                    ...
                    if (movie10 != null) {
                        ...
                        btmMore10.setOnClickListener(View.OnClickListener {
                            val intent = Intent(this, Detalle::class.java).apply {
                                putExtra("ID", movie10.getString("imdbID"))
                            }
                            startActivity(intent)
                        })
                    }else {
